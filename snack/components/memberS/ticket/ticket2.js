      ...
      <div className=" border1">
        <div className={classnames("itemgroup item1", styles["mb-0"])}>
          ...
          <div className="card">
            ...
            {tab == 1 && data.map((v, i) => {
              return (
                <div className={classnames("card-body time-wrap   border-1-bg  ", styles.flexBetween)}>
                  <div>
                    <Image src="/ch.jpeg" alt="Description" width={80} height={80} />
                  </div>
                  <div className='p16'>
                    <h5 >{v.level_id} <br /><span>{v.play_date}</span> </h5>
                  </div>
                  <div className='ma-md-no ma-auto' >
                    <h5> {v.level_count} <div className='text-color'> {v.clear_score}分</div></h5>
                  </div>
