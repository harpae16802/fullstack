...
export default function ProductDetailCardCopy({
  imageUrl = '',
  seller = '',
  product = '',
  description = '',
      ...
      <div className={styles.detailContainer}>
        ...
        <div className={styles.detailTextArray}>
          ...
          >
            ...
            <button className="btn btn-primary ms-2" onClick={handleBuyNow}>立即購買</button>
          </div>
          ...
          {/* 成分 */}
          <div className={styles.detailIngredient} style={{marginLeft:'110px'}}>含有 : {ingredient}</div>
          ...
          {/* 營養成分表 */}
          <div className={styles.nutritionIngredient}  style={{marginLeft:'110px'}}>{nutrition}</div>
