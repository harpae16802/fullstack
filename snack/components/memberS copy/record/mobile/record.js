        ...
        <div className={classNames("itemgroup item1", styles["mb-0"])}>
          ...
          <div className="card">
            {Array(4).fill(1).map((_, index) => (
              <div className={classNames("card full-width card-body mb-0")} key={index}>
                <div className={classNames("full-width", "mx-0 px-3 py-3", styles.flexBetween)}>
                  ...
                  <button type="button" style={{ height: "50px" }} className={classNames("btn sm-btn", styles["btn-parmary"])}>查看詳細</button>
                  <button type="button" style={{ height: "50px" }} className={classNames("btn sm-btn", styles["text-color"], styles["border-001"])}>到店面</button>
                </div>
