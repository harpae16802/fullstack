    ...
    <div className={classNames("ticket")}>
      ...
      <ul className={classNames("nav nav-tabs d-flex flex-grow-1 px-5")}>
        ...
        <li className="nav-item flex-grow-1">
          <Link aria-current="page" href="/?id=2" style={{ border: "2px solid grey" }} className={classNames("nav-link me-1", styles['border-1'], styles["btn-parmary-white"])}>成就紀錄</Link>
        </li>
      </ul>
        ...
        <div className={classNames("itemgroup item1", styles["mb-0"])}>
          <div className="card">
            {Array(4).fill(1).map((v, i) => (
              <div key={i} className={classNames("border-1-bg card-body", styles.flexBetween)}>
