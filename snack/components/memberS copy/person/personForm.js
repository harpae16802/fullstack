        ...
        <form onSubmit={handleSubmit(onSubmit)} method="POST">
          ...
          <div className="row">
            <div className={`col-12 col-md-6`}>
              ...
              {errors.nameErr && <div className="form-text"> {errors["nameErr"]?.message}</div>}
            </div>
            <div className="col-12 col-md-6">
            ...
            <div className="col-12 col-md-4">
              <div className="face.input-group pa-1 " style={{ paddingRight: 0 }}>
                <select className="form-select pa-0"
                  ...
                  ref={yearVal} onChange={selectChange} defaultValue="年" id="inputGroupSelect01">
            ...
            <div className="col-12 col-md-4">
              <div className="face.input-group pa-1 " style={{ paddingRight: 0 }}>
                <select className="form-select pa-0" ref={monthVal}
                  ...
                  onChange={selectChange} defaultValue="月" id="inputGroupSelect02">
            ...
            <div className="col-12 col-md-4">
              <div className="face.input-group pa-1 " style={{ paddingRight: 0 }}>
                <select className="form-select pa-0"
                  ...
                  ref={dateVal} defaultValue="Choose..." id="inputGroupSelect03">
                  <option >日</option>
                  {birthD.map((v, i) => {
                    return <option value={v} key={v}>{v}</option>;
                  })}
