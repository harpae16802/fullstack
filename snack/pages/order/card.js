...
import { FAVORITE_PRODUCTS } from '@/data/memberList' // 確保這個路徑和變量定義是正確的
...
export default function Card({ product }) {
  ...
  const toggleFavoriteProducts = async () => {
    try {
      const r = await fetch(`${FAVORITE_PRODUCTS}/${product.product_id}`)
                    ...
                    <div className={styles.detailTextArray}>
                      ...
                      >
                        <div className="accordion-item">
                          ...
                          >
                            <div className={`accordion-body ${styles.detailIngredient}`}>
                      ...
                      <div className="accordion accordion-flush" id="accordionFlushExample">
                        <div className="accordion-item">
                          ...
                          <div
                            ...
                            data-bs-parent="#accordionFlushExample"
                          >
                            <div className={`accordion-body ${styles.nutritionIngredient}`}>
