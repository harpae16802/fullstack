        ...
        <div className="row"  >
          ...
          <div className="col-12 col-xl-8">
            <div className={classNames("", styles["main-O-baground"])}>
              <div className={classNames("row", styles["main-O-baground-border50"],styles.iconReverse, styles["setMdGrid"])}>
                <div className={classNames("col-12 col-xl-9 xl-full-width")}>
                  <div className="container">
                    <PersonForm />
                  </div>
                </div>
