...
import NightAnimation from '@/assets/hunter.json'
...
// lottie-react
export function HunterLoader({ show = false }) {
  return (
    <div className={`night-loader-bg ${show ? '' : 'night-loader--hide'}`}>
      <Lottie
        className={`night-loader ${show ? '' : 'night-loader--hide'}`}
